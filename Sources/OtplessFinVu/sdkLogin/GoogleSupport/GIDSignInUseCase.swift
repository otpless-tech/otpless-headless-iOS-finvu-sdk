...
//  OtplessSDK
//
//  Created by OTPless on 19/02/25.
//
...
internal class GIDSignInUseCase: NSObject, GoogleAuthProtocol {
    func signIn(
        ...
        os_log("OTPLESS: Google support not initialized. Please add OtplessFinVu/GoogleSupport to your Podfile")
        return GoogleSignInResponse(
            success: false,
            idToken: nil,
            error: "Google support not initialized. Please add OtplessFinVu/GoogleSupport to your Podfile"
        )
    }
